      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                Expanded(child: TextFormField(
                  ...
                  decoration: InputDecoration(hintText: "Ask your queries",border: OutlineInputBorder(borderSide: BorderSide(
                  color: textfieldGrey,
                ),),),)),
            ...
            ).box.height(80).padding(EdgeInsets.symmetric(horizontal: 12)).margin(EdgeInsets.only(bottom: 8)).make(),
          ],
        ),
      ),
    );
